    ...
    private static function definitions(): array
    {
        return [
            ...
            new NotificationEvent(
                ...
                action: ['label' => 'Open in admin', 'url' => '/admin/tickets'],
                required: ['reference', 'subject', 'author'],
                icon: 'ticket',
                staffOnly: true,
            ),
            ...
            new NotificationEvent(
                ...
                action: ['label' => 'View post', 'url' => '/admin/posts'],
                required: ['title'],
                icon: 'check',
                staffOnly: true,
            ),
            new NotificationEvent(
                ...
                action: ['label' => 'View subscriptions', 'url' => '/admin/subscriptions'],
            ...
            new NotificationEvent(
                ...
                action: ['label' => 'View tool analytics', 'url' => '/admin/tool-analytics'],
