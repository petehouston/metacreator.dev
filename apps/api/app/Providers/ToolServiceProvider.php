...
final class ToolServiceProvider extends ServiceProvider
{
    ...
    private const RUNNERS = [
        ...
        Runners\HashtagExtractorRunner::class,
        ...
        Runners\InstagramAvatarDownloaderRunner::class,
        Runners\InstagramBioPreviewRunner::class,
        Runners\InstagramImageDownloaderRunner::class,
        Runners\InstagramMoneyCalculatorRunner::class,
        Runners\InstagramPostGeneratorRunner::class,
        Runners\LinkExpanderRunner::class,
        Runners\LinkedInPostPreviewRunner::class,
        Runners\MetadataPreviewRunner::class,
        Runners\PinImageSizerRunner::class,
        Runners\PinterestImageDownloaderRunner::class,
        Runners\PinterestPinGeneratorRunner::class,
        ...
        Runners\SerpPreviewRunner::class,
        Runners\SocialEmbedCodeGeneratorRunner::class,
        Runners\SocialImageDownloaderRunner::class,
        Runners\SocialImageResizerRunner::class,
        Runners\SocialLinkShortenerRunner::class,
        Runners\SpotifyCoverArtDownloaderRunner::class,
        ...
        Runners\ThreadsImageDownloaderRunner::class,
        Runners\ThreadsPostPreviewRunner::class,
        Runners\TikTokCommentGeneratorRunner::class,
        Runners\TikTokMoneyCalculatorRunner::class,
        Runners\TweetScreenshotRunner::class,
        Runners\TwitchImageDownloaderRunner::class,
        Runners\TwitchMoneyCalculatorRunner::class,
        Runners\UrlCleanerRunner::class,
        Runners\UsernameAvailabilityRunner::class,
        Runners\UtmBuilderRunner::class,
        Runners\WordCounterRunner::class,
        Runners\XImageDownloaderRunner::class,
        Runners\XReplyGeneratorRunner::class,
        Runners\YouTubeAdBreakPlannerRunner::class,
        Runners\YouTubeAdvertiserFriendlyCheckerRunner::class,
        Runners\YouTubeBannerSafeAreaRunner::class,
        ...
        Runners\YouTubeCommentGeneratorRunner::class,
        ...
        Runners\YouTubeHashtagGeneratorRunner::class,
        Runners\YouTubeImageDownloaderRunner::class,
        Runners\YouTubeLinkShortenerRunner::class,
        ...
        Runners\YouTubeSubtitleDownloaderRunner::class,
